...
import { ReactNode, SelectHTMLAttributes, InputHTMLAttributes, useEffect } from "react";
      ...
      <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-xl border border-graphite-700 bg-graphite-800 p-6 shadow-2xl">
        <div className="mb-5 flex items-center justify-between">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Tutup"
            className="rounded-md p-1 text-cream-dim hover:bg-graphite-800 hover:text-cream"
          >
            ✕
          </button>
        </div>
